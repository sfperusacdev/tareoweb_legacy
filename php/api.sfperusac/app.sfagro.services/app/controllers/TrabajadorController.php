...
class TrabajadorController
{
                    ...
                    if ($array->success) {
						...
						if($datos[0]->ap_paterno==null || $datos[0]->ap_paterno==''){
							...
							return;
								...
								$row_array['Paterno'] = ($datos[0]->ap_paterno);
								}
                        
                        $row_array['Materno'] = ($datos[0]->ap_materno);
                        $row_array['Nombre'] = $datos[0]->nombres;
						...
						$ubigeo1 =str_replace("-", "/", $datos[0]->ubigeotext);
                        $ubigeo = explode('/',$ubigeo1);
	...
	public function consultar_RENIEC3()
    {
		$dni = $_POST['dni'];
		//echo $dni;
        try {
