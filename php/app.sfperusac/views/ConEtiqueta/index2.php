                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col app-email-sidebar border-end flex-grow-0" id="app-email-sidebar">
                                                        <div class="btn-compost-wrapper d-grid">
                                                            <button class="btn btn-primary btn-compose waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#emailComposeSidebar" id="emailComposeSidebarLabel">
                                                                Compose
                                                            </button>
                                                        </div>
                                                        <!-- Email Filters -->
                                                        <div class="email-filters pt-4 pb-2 ps ps--active-y">
                                                            ...
                                                            <ul class="email-filter-folders list-unstyled">
                                                                <li class="d-flex justify-content-between align-items-center mb-1" data-target="inbox">
                                                                ...
                                                                <li class="d-flex mb-1 active" data-target="sent">
                                                                    <a href="javascript:void(0);" class="d-flex flex-wrap align-items-center">
                                                            ...
                                                            <div class="ps__rail-y" style="top: 0px; height: 376px; right: 0px;">
                                                    ...
                                                    <div class="col app-emails-list">
                                                        <div class="card shadow-none border-0 rounded-0">
                                                            <div class="card-body emails-list-header p-3 py-2">
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center px-3 mt-2">
                                                                    <div class="d-flex align-items-center w-100">
                                                                        <i class="icon-base ri ri-menu-line icon-lg cursor-pointer d-block d-lg-none me-4 mb-4" data-bs-toggle="sidebar" data-target="#app-email-sidebar" data-overlay=""></i>
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center ps-1">
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="btn btn-icon btn-text-secondary rounded-pill me-1 waves-effect">
                                                                            <i class="icon-base ri ri-delete-bin-7-line icon-22px email-list-delete cursor-pointer"></i>
                                                                        </div>
                                                                        <div class="btn btn-icon btn-text-secondary rounded-pill me-1 waves-effect">
                                                                            <i class="icon-base ri ri-mail-open-line icon-22px email-list-read cursor-pointer"></i>
                                                                        </div>
                                                                        <div class="dropdown me-1">
                                                                            <button class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect" type="button" id="dropdownMenuFolderOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        ...
                                                                        <div class="dropdown mx-1">
                                                                            <button class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow waves-effect" data-bs-toggle="dropdown" aria-expanded="true" id="dropdownLabelOne">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        <span class="btn btn-icon btn-text-secondary rounded-pill me-1 waves-effect">
                                                                            <i class="icon-base ri ri-refresh-line icon-22px scaleX-n1-rtl cursor-pointer email-refresh"></i>
                                                                        </span>
                                                                        <div class="dropdown">
                                                                            <button class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect" type="button" id="emailsActions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                <i class="icon-base ri ri-more-2-line icon-22px"></i>
                                                                            </button>
                                                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="emailsActions">
                                                                                <a class="dropdown-item waves-effect" href="javascript:void(0)">Mark as read</a>
                                                                                <a class="dropdown-item waves-effect" href="javascript:void(0)">Mark as unread</a>
                                                                                <a class="dropdown-item waves-effect" href="javascript:void(0)">Delete</a>
                                                                                <a class="dropdown-item waves-effect" href="javascript:void(0)">Archive</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <!-- Email List: Items -->
                                                            <div class="email-list pt-0 ps">
                                                                <ul class="list-unstyled m-0">
                                                                    <li class="email-list-item email-marked-read d-flex align-items-center d-none" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                            ...
                                                                            <span class="ms-sm-2 me-3 d-sm-inline-block d-none"><i class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                                                            ...
                                                                            <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                                                                ...
                                                                                <ul class="list-inline email-list-item-actions">
                                                                                    <li class="list-inline-item email-delete btn btn-icon btn-text-secondary rounded-pill waves-effect">
                                                                                        <i class="icon-base ri ri-delete-bin-7-line icon-22px"></i>
                                                                                    </li>
                                                                                    <li class="list-inline-item email-unread btn btn-icon btn-text-secondary rounded-pill waves-effect">
                                                                                        <i class="icon-base ri ri-mail-line icon-22px"></i>
                                                                                    </li>
                                                                                    <li class="list-inline-item btn btn-icon btn-text-secondary rounded-pill waves-effect">
                                                                    ...
                                                                    <li class="email-list-item email-marked-read d-flex align-items-center d-block" data-sent="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                    ...
                                                                    <li class="email-list-item email-marked-read d-flex align-items-center d-none" data-draft="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                            ...
                                                                            <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                                                                <span class="email-list-item-attachment icon-base ri ri-attachment-2 icon-22px cursor-pointer me-2 float-end float-sm-none"></span>
                                                                    ...
                                                                    <li class="email-list-item d-flex align-items-center d-none" data-starred="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                            ...
                                                                            <div class="email-list-item-meta ms-auto d-flex align-items-center">
                                                                                ...
                                                                                <ul class="list-inline email-list-item-actions">
                                                                                    ...
                                                                                    <li class="list-inline-item email-read btn btn-icon btn-text-secondary rounded-pill waves-effect">
                                                                    ...
                                                                    <li class="email-list-item email-marked-read d-flex align-items-center d-none" data-spam="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                    ...
                                                                    <li class="email-list-item d-flex align-items-center d-none" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                    ...
                                                                    <li class="email-list-item email-marked-read d-flex align-items-center d-none" data-trash="true" data-bs-toggle="sidebar" data-target="#app-email-view">
                                                                        <div class="d-flex align-items-center w-100">
                                                                            <div class="form-check mb-0 ms-2 mt-1">
                                                                ...
                                                                <div class="ps__rail-y" style="top: 0px; height: 410px; right: 0px;">
                                                    ...
                                                    <div class="col app-email-view flex-grow-0 bg-lightest" id="app-email-view">
                                                        <div class="card shadow-none border-0 rounded-0 app-email-view-header p-5 pt-md-4 py-2">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <span class="btn btn-icon p-0 me-2 btn-text-secondary rounded-pill text-body-secondary waves-effect">
                                                                        <i class="icon-base ri ri-arrow-left-s-line icon-22px scaleX-n1-rtl"></i>
                                                                    </span>
                                                                    <span class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect">
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center">
                                                                <div class="d-flex align-items-center">
                                                                    <span class="btn btn-icon btn-text-secondary rounded-pill me-1 waves-effect"><i class="icon-base ri ri-delete-bin-7-line icon-22px cursor-pointer"></i></span>
                                                                    <span class="btn btn-icon btn-text-secondary rounded-pill me-1 waves-effect"><i class="icon-base ri ri-mail-line icon-22px cursor-pointer" data-bs-toggle="sidebar" data-target="#app-email-view"></i></span>
                                                                    <div class="dropdown">
                                                                        <button class="btn btn-icon btn-text-secondary rounded-pill p-0 me-1 waves-effect" type="button" id="dropdownMenuFolderTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                            <i class="icon-base ri ri-folder-line icon-22px"></i>
                                                                        </button>
                                                                    ...
                                                                    <div class="dropdown">
                                                                        <button class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect" type="button" id="dropdownLabelTwo" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                            <i class="icon-base ri ri-price-tag-3-line icon-22px"></i>
                                                                        </button>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="dropdown ms-1">
                                                                        <button class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect" type="button" id="dropdownMoreOptions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                            <i class="icon-base ri ri-more-2-line icon-22px"></i>
                                                                        </button>
                                                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMoreOptions">
                                                                            ...
                                                                            <a class="dropdown-item d-sm-none d-block waves-effect" href="javascript:void(0)">
                                                        ...
                                                        <div class="app-email-view-content py-4 ps ps--active-y">
                                                            ...
                                                            <div class="card email-card-prev mx-sm-6 mx-3">
                                                                <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <span class="btn btn-icon btn-text-secondary rounded-pill waves-effect"><i class="icon-base ri ri-attachment-2 icon-22px cursor-pointer"></i></span>
                                                                        <span class="btn btn-icon btn-text-secondary rounded-pill waves-effect"><i class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                                                        <div class="dropdown">
                                                                            <button class="btn btn-icon btn-text-secondary rounded-pill p-0 waves-effect" type="button" id="dropdownEmailOne" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                <i class="icon-base ri ri-more-2-line icon-22px"></i>
                                                                            </button>
                                                                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownEmailOne">
                                                                                <a class="dropdown-item scroll-to-reply waves-effect" href="javascript:void(0)">
                                                            ...
                                                            <div class="card email-card-last mx-sm-6 mx-3 mt-4">
                                                                <div class="card-header d-flex justify-content-between align-items-center flex-wrap border-bottom">
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <span class="btn btn-icon btn-text-secondary rounded-pill waves-effect"><i class="email-list-item-bookmark icon-base ri ri-star-line icon-22px cursor-pointer"></i></span>
                                                                        <div class="dropdown">
                                                                            <button class="btn btn-icon btn-text-secondary rounded-pill dropdown-toggle hide-arrow waves-effect" id="dropdownEmailTwo" data-bs-toggle="dropdown" aria-expanded="true">
                                                                                <i class="icon-base ri ri-more-2-line icon-22px"></i>
                                                                            </button>
                                                            ...
                                                            <div class="email-reply card mt-4 mx-sm-6 mx-3 mb-4">
                                                                ...
                                                                <div class="card-body pt-0 ps-3">
                                                                    <div class="d-flex justify-content-start">
                                                                        <div class="email-reply-toolbar border-0 w-100 ps-0 pb-4 ql-toolbar ql-snow">
                                                                    ...
                                                                    <div class="email-reply-editor ql-container ql-snow">
                                                                        <div class="ql-editor ql-blank" contenteditable="true" data-placeholder="Write your message... ">
                                                                            <p><br></p>
                                                                        </div>
                                                                    ...
                                                                    <div class="d-flex justify-content-end align-items-center mt-4">
                                                                        <div class="cursor-pointer btn btn-text-secondary text-secondary me-4 waves-effect">
                                                            ...
                                                            <div class="ps__rail-y" style="top: 0px; height: 328px; right: 0px;">
                                                                <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 144px;"></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <!-- Email View -->
                                                        ...
                                                        <div class="modal-content p-0">
                                                            <div class="modal-header py-3 justify-content-between">
                                                                ...
                                                                <div class="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <button type="button" class="btn btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-dismiss="modal" aria-label="Close">
                                                                ...
                                                                <form class="email-compose-form">
                                                                    <div class="email-compose-to d-flex justify-content-between align-items-center">
                                                                        ...
                                                                        <div class="select2-primary border-0 shadow-none flex-grow-1 mx-2">
                                                                            <div class="position-relative"><select class="select2 select-email-contacts form-select select2-hidden-accessible" id="emailContacts" name="emailContacts" multiple="" data-select2-id="emailContacts" tabindex="-1" aria-hidden="true">
                                                                                    <option data-avatar="" value="Jane Foster">Jane Foster</option>
                                                                                    <option data-avatar="" value="Donna Frank">Donna Frank</option>
                                                                                    <option data-avatar="" value="Gabrielle Robertson">Gabrielle Robertson</option>
                                                                                    <option data-avatar="" value="Lori Spears">Lori Spears</option>
                                                                                    <option data-avatar="" value="Sandy Vega">Sandy Vega</option>
                                                                                    <option data-avatar="" value="Cheryl May">Cheryl May</option>
                                                                    ...
                                                                    <div class="email-compose-message">
                                                                        ...
                                                                        <div class="d-flex justify-content-end mx-n1">
                                                                            <div class="email-editor-toolbar border-0 w-100 px-0 ql-toolbar ql-snow">
                                                                                <span class="ql-formats me-0">
                                                                                    <button class="ql-bold" type="button"><svg viewBox="0 0 18 18">
                                                                                            <path class="ql-stroke" d="M5,4H9.5A2.5,2.5,0,0,1,12,6.5v0A2.5,2.5,0,0,1,9.5,9H5A0,0,0,0,1,5,9V4A0,0,0,0,1,5,4Z"></path>
                                                                                            <path class="ql-stroke" d="M5,9h5.5A2.5,2.5,0,0,1,13,11.5v0A2.5,2.5,0,0,1,10.5,14H5a0,0,0,0,1,0,0V9A0,0,0,0,1,5,9Z"></path>
                                                                        ...
                                                                        <hr class="mx-n6 my-0">
                                                                        <div class="email-editor border-0 mx-n5 ql-container ql-snow">
                                                                            <div class="ql-editor ql-blank" contenteditable="true" data-placeholder="Message ">
                                                                                <p><br></p>
                                                                            </div>
                                                                            <div class="ql-tooltip ql-hidden"><a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a><input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL"><a class="ql-action"></a><a class="ql-remove"></a></div>
                                                                        </div>
                                                                    ...
                                                                    <div class="email-compose-actions d-flex justify-content-between align-items-center my-4">
                                                                        <div class="d-flex align-items-center">
                                                                            <div class="btn-group">
                                                                                <button type="button" class="btn btn-primary dropdown-toggle email-send-btn waves-effect waves-light" data-bs-toggle="dropdown" aria-expanded="false">
                                                                                    Send <i class="icon-base ri ri-send-plane-line icon-sm scaleX-n1-rtl ms-2"></i>
                                                                                </button>
                                                                                <ul class="dropdown-menu">
                                                                                    <li><a class="dropdown-item waves-effect" href="javascript:void(0);">Schedule send</a></li>
                                                                                    <li><a class="dropdown-item waves-effect" href="javascript:void(0);">Save draft</a></li>
                                                                                </ul>
                                                                            </div>
                                                                            <label for="attach-file" class="btn btn-icon btn-text-secondary rounded-pill ms-4 waves-effect"><i class="icon-base ri ri-attachment-2 cursor-pointer icon-20px"></i></label>
                                                                            <input type="file" name="file-input" class="d-none" id="attach-file">
                                                                        </div>
                                                                        <div class="d-flex align-items-center gap-4">
                                                                            <div class="dropdown">
                                                                                <button class="btn btn-sm btn-icon btn-text-secondary p-0 waves-effect" type="button" id="dropdownMoreActions" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                    <i class="icon-base ri ri-more-2-line icon-20px"></i>
                                                                                </button>
                                                                                <ul class="dropdown-menu" aria-labelledby="dropdownMoreActions">
                                                                                    <li><button type="button" class="dropdown-item waves-effect">Add Label</button></li>
                                                                                    <li><button type="button" class="dropdown-item waves-effect">Plain text mode</button></li>
                                                                                    <li>
                                                                                        <hr class="dropdown-divider">
                                                                                    </li>
                                                                                    <li><button type="button" class="dropdown-item waves-effect">Print</button></li>
                                                                                    <li><button type="button" class="dropdown-item waves-effect">Check Spelling</button></li>
                                                                                </ul>
                                                                            </div>
                                                                            <button type="reset" class="btn btn-icon btn-text-secondary rounded-pill waves-effect" data-bs-dismiss="modal" aria-label="Close">
