    ...
    $(ret).each(function (i, e) {
     ...
     //  doc.text("    "+fecha,0, 21);
       ...
       contador=contador+1;
        ...
        doc.addImage(imgData2, "png", 46, 0.5, 0, 17);
        doc.text("    SF-Alaya "+e.num_numero+ ' | ' + ("0"+(contador)).substr(-2) ,44, 20);
        doc.text("    C.L.P=004-04187-0....." ,44, 24);
       // doc.text("    "+fecha,44, 21);
        ...
        doc.addImage(imgData3, "png", 90, 0.5, 0, 17);
        doc.text("    SF-Alaya "+e.num_numero+ ' | ' + ("0"+(contador)).substr(-2) ,88, 20);
	doc.text("    C.L.P=004-04187-0....." ,90, 24);
